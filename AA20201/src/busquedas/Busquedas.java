...
public class Busquedas {
     ...
     //Array Bi********************************************************************************************************************************************
    public static int[] busquedaLinealArrayBi(int[][] datos, int x, boolean mostrarResultado)
    {
        int[] pos = new int[2];
        for(int y = 0; y<datos.length; y++)
        {
            for(int n =0; n<datos.length; n++)
            {
                if(datos[y][n] == x)
                {
                    pos[0] = y;
                    pos[1] = n;
                    mostrarArrayBi(mostrarResultado,pos);
                    return pos;
                }
            }
    ...
    public static void mostrarArrayBi(boolean mostrarResultado,int[] pos)
    {
